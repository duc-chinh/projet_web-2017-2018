...
<div class="container">
	...
	<form method="post" class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-xs-4">
				<input type="text" name="nom" class="form-control" id="inputLastname" placeholder="Nom" size="30" required value="<?= $data['nom'] ?? "" ?>">
			</div> <!-- col-xs-4 -->
		</div> <!-- form-group -->
		...
		<div class="form-group">
			...
			<div class="col-xs-4">
				<input type="text" name="prenom" class="form-control" id="inputFirstname" placeholder="Prénom" size="30" required value="<?= $data['prenom'] ?? "" ?>">
			</div> <!-- col-xs-4 -->
		</div> <!-- form-group -->
